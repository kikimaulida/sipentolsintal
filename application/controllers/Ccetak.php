<?php
	...
	class Ccetak extends CI_Controller {
	    ...
	    function cetak_klasifikasi($klasifikasi)
		{
	       	$this->load->library('pdf');
	        $pdf = new FPDF('L','mm','legal');
	        $pdf->SetMargins(20,20,20);
	        ...
	        $pdf->SetFont('Arial','',8);
	        $this->load->model('m_usaha');
	        $usaha = $this->m_usaha->cetak_klasifikasi($klasifikasi)->result();
	        $no=1;
	        foreach ($usaha as $row){
	        	$pdf->Cell(10,6,$no++,1,0);
	        	$pdf->Cell(30,6,$row->nik,1,0);
	    ...
	    function cetak_kategori($kategori)
		{
	       	$this->load->library('pdf');
	        $pdf = new FPDF('L','mm','legal');
	        $pdf->SetMargins(20,20,20);
	        ...
	        $pdf->SetFont('Arial','',8);
	        $this->load->model('m_usaha');
	        $usaha = $this->m_usaha->cetak_kategori($kategori)->result();
	        $no=1;
	        foreach ($usaha as $row){
	        	$pdf->Cell(10,6,$no++,1,0);
	        	$pdf->Cell(30,6,$row->nik,1,0);
	    ...
	    function cetak_kecamatan($kecamatan)
		{
	       	$this->load->library('pdf');
	        $pdf = new FPDF('L','mm','legal');
	        $pdf->SetMargins(20,20,20);
	        ...
	        $pdf->SetFont('Arial','',8);
	        $this->load->model('m_usaha');
	        $usaha = $this->m_usaha->cetak_kecamatan($kecamatan)->result();
	        $no=1;
	        foreach ($usaha as $row){
	        	$pdf->Cell(10,6,$no++,1,0);
	        	$pdf->Cell(30,6,$row->nik,1,0);
	    ...
	    function cetak_kelurahan($kelurahan)
		{
	       	$this->load->library('pdf');
	        $pdf = new FPDF('L','mm','legal');
	        $pdf->SetMargins(20,20,20);
	        ...
	        $pdf->SetFont('Arial','',8);
	        $this->load->model('m_usaha');
	        $usaha = $this->m_usaha->cetak_kelurahan($kelurahan)->result();
	        $no=1;
	        foreach ($usaha as $row){
	        	$pdf->Cell(10,6,$no++,1,0);
	        	$pdf->Cell(30,6,$row->nik,1,0);
	    ...
	    public function export_allusaha()
	    {
	        ...
	        $object->getActiveSheet()->setCellValue('H1', 'Kelurahan');
	        $object->getActiveSheet()->setCellValue('I1', 'Telepon');
	        $object->getActiveSheet()->setCellValue('J1', 'Bergabung');
	        ...
	        foreach ($usaha as $row){
	        	...
	        	$object->getActiveSheet()->setCellValue('H'.$baris, $row->nama_kelurahan);
	        	$object->getActiveSheet()->setCellValue('I'.$baris, $row->telepon);
	        	$object->getActiveSheet()->setCellValue('J'.$baris, $row->bergabung);
		    ...
		    $object->getActiveSheet()->getColumnDimension('H')->setWidth(20); //kelurahan
		    $object->getActiveSheet()->getColumnDimension('I')->setWidth(15); //telepon
		    $object->getActiveSheet()->getColumnDimension('J')->setWidth(15); //bergabung
	    ...
	    public function export_klasifikasi($klasifikasi)
	    {
	    	$this->load->model('m_usaha');
	        $usaha = $this->m_usaha->cetak_klasifikasi($klasifikasi)->result();
	    ...
	    public function export_kategori($kategori)
	    {
	    	$this->load->model('m_usaha');
	        $usaha = $this->m_usaha->cetak_kategori($kategori)->result();
	    ...
	    public function export_kecamatan($kecamatan)
	    {
	    	$this->load->model('m_usaha');
	        $usaha = $this->m_usaha->cetak_kecamatan($kecamatan)->result();
	    ...
	    public function export_kelurahan($kelurahan)
	    {
	    	$this->load->model('m_usaha');
	        $usaha = $this->m_usaha->cetak_kelurahan($kelurahan)->result();
