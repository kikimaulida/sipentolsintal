                   ...
                   <!--  <div class="card-body">
                    ...
                    <!-- <form  method="get" class="form-horizontal">
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="" class="form-control" value="<?=$data->nik?>" disabled>
                        </div>
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-sm-3">
                            <textarea name="deskripsi" rows="2" class="form-control" disabled><?=$data->nama_lengkap?></textarea>
                        </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            <textarea name="deskripsi" rows="2" class="form-control" disabled><?=$data->email?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="" class="form-control" value="<?=$data->username?>" disabled>
                        </div>
